...
//    virtual display_type getType() { return DISPLAY_TYPE_UNKNOWN; }
//
...
//    virtual display_interface_type getUserInterfaceType() { return DISPLAY_INTERFACE_TYPE_UNKNOWN; }
//
//    /// @brief Получить тип библиотеки использованный для подключения дисплея
//    /// @return DISPLAY_LIB_UNKNOWN, DISPLAY_LIB_U8G2,
//    virtual display_library getDisplayLibraryType() { return DISPLAY_LIB_UNKNOWN; }
//
//    /// @brief Получить библиотеку дисплея
//    /// @return Основной класс библиотеки, в зависимости от типа
//    virtual void* getLibrary() {return nullptr;}
//
